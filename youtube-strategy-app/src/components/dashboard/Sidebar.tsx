...
export function Sidebar() {
  ...
  return (
    <aside
      className="fixed left-0 top-0 h-full w-60 flex flex-col border-r z-20"
      style={{
    ...
    >
      {/* Logo */}
      <div className="flex items-center gap-3 px-6 py-5 border-b" style={{ borderColor: "var(--border-default)" }}>
        <div
      ...
      <div className="px-3 py-4 border-t" style={{ borderColor: "var(--border-default)" }}>
        <p className="text-xs px-3" style={{ color: "var(--text-muted)" }}>
          Basado en Hormozi · MrBeast · Sáenz
        </p>
      </div>
    </aside>
  );
